...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-lg border px-3 py-2 text-sm whitespace-nowrap",
        "backdrop-blur-sm bg-white/5 border-white/10 text-white",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "backdrop-blur-xl bg-gray-900/95 text-white border border-white/10",
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-gray-500 px-3 py-1.5 text-xs font-medium", className)}
      {...props}
    />
  )
}
